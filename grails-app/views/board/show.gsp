		...
		<div id="show-board" class="content scaffold-show" role="main">
			...
			<ol class="property-list board">
				...
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="board.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${boardInstance}" field="title"/></span>
				...
				<li class="fieldcontain">
					<span id="content-label" class="property-label"><g:message code="board.content.label" default="Content" /></span>
						...
						<span class="property-value" aria-labelledby="content-label"><g:fieldValue bean="${boardInstance}" field="content"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${boardInstance?.user}">
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="board.user.label" default="User" /></span>
					
						<span class="property-value" aria-labelledby="user-label"><g:link controller="user" action="show" id="${boardInstance?.user?.id}">${boardInstance?.user?.name}</g:link></span>
